...
const Header = () => {
  return <header
    ...
    <div className="flex gap-1 items-center">
      ...
      <span className="text-bright-sun-400 text-3xl">
        Jobs Hub
      </span>
    </div>
    <div className="flex  items-center justify-around gap-6">
      <a href="" className="hover:text-bright-sun-400">Find Jobs</a>
      <a href="" className="hover:text-bright-sun-400">Find Talent</a>
      <a href="" className="hover:text-bright-sun-400">Post Job</a>
      <a href="" className="hover:text-bright-sun-400">About Us</a>
    </div>
    <div className="flex gap-3 items-center ">
      <span>User</span>
      <Avatar src={avatar} />
      <Indicator color="pink" size={8} offset={6} processing>
